# Домашнее задание к занятию "`Хранение в K8s. Часть 1`" - `Никулин Михаил Сергеевич`
...
```bash
nikulinn@nikulin:~/other/kuber_2-1$ kubectl create ns dz2-1
namespace/dz2-1 created

nikulinn@nikulin:~/other/kuber_2-1$ kubectl get ns -o wide
NAME              STATUS   AGE
...
```bash
nikulinn@nikulin:~/other/kuber_2-1/scr$ kubectl apply -f deployment_busybox_multitool.yaml 
...
nikulinn@nikulin:~/other/kuber_2-1/scr$ kubectl exec -n dz2-1 netology-app-multitool-busybox-756d85d698-t88g5 -c multitool -it -- bash
